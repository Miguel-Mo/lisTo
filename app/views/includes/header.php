...
<meta name="theme-color" content="#ffffff">
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet"
        href="<?php echo RUTA_URL; ?>/public/vendor/almasaeed2010/adminlte/plugins/fontawesome-free/css/all.min.css">
    <!-- Tempusdominus Bootstrap 4 -->
    <link rel="stylesheet"
        href="<?php echo RUTA_URL; ?>/public/vendor/almasaeed2010/adminlte/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css">
    <!-- iCheck -->
    <link rel="stylesheet"
        href="<?php echo RUTA_URL; ?>/public/vendor/almasaeed2010/adminlte/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
    <!-- Theme style -->
    <link rel="stylesheet"
        href="<?php echo RUTA_URL; ?>/public/vendor/almasaeed2010/adminlte/dist/css/adminlte.min.css">
    <!-- overlayScrollbars -->
    <link rel="stylesheet"
        href="<?php echo RUTA_URL; ?>/public/vendor/almasaeed2010/adminlte/plugins/overlayScrollbars/css/OverlayScrollbars.min.css">
    <!-- Daterange picker -->
    <link rel="stylesheet"
        href="<?php echo RUTA_URL; ?>/public/vendor/almasaeed2010/adminlte/plugins/daterangepicker/daterangepicker.css">
    <!-- summernote -->
    <link rel="stylesheet"
        href="<?php echo RUTA_URL; ?>/public/vendor/almasaeed2010/adminlte/plugins/summernote/summernote-bs4.min.css">
    <!-- SELECT 2 -->
    <link rel="stylesheet"
        href="<?php echo RUTA_URL; ?>/public/vendor/almasaeed2010/adminlte/plugins/select2/css/select2.min.css">
    <!-- SELECT 2 BOOTSTRAP 4 -->
    <link rel="stylesheet"
        href="<?php echo RUTA_URL; ?>/public/vendor/almasaeed2010/adminlte/plugins/select2-bootstrap4-theme/select2-bootstrap4.min.css">

    <!-- SWEETALERT 2 -->
    <link rel="stylesheet"
        href="<?php echo RUTA_URL; ?>/public/vendor/almasaeed2010/adminlte/plugins/sweetalert2/sweetalert2.min.css">
    <link rel="stylesheet"
        href="<?php echo RUTA_URL; ?>/public/vendor/almasaeed2010/adminlte/plugins/sweetalert2-theme-bootstrap-4/bootstrap-4.min.css">
