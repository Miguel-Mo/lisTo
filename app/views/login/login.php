...
<head>
    ...
    <!-- icheck bootstrap -->
    <link rel="stylesheet" href="public/vendor/almasaeed2010/adminlte/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
    <!-- Theme style -->
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo RUTA_URL; ?>/public/img/favicon-16x16.png?v=alJ7x0266R">
...
<body class="hold-transition login-page h-100 mt-4">
    <div class="login-box">
        <div class="login-logo">
            <img src="<?php echo RUTA_URL; ?>/public/img/logo_transparent.png" class="img-fluid" alt="Responsive image">
        </div>
        <!-- /.login-logo -->
